...
class Financial extends BaseController
{
    ...
    public function subscriptions()
    {
        ...
        $subs = $db->table('subscriptions s')->select('s.*, u.name as user_name, u.email, p.name as plan_name')            
    ...
    public function report()
    {
        ...
        $byMonth = $db->table('payments')->select('DATE_FORMAT(paid_at,"%m") as month, SUM(amount) as total, COUNT(*) as count')
        ...
        $byPlan = $db->table('payments pay')->select('p.name as plan_name, SUM(pay.amount) as total, COUNT(*) as count')            
