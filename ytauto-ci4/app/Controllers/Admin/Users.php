...
class Users extends BaseController
{
    ...
    public function show(int $id)
    {
        ...
        $subscriptions = $db->select('s.*, p.name as plan_name')
        ...
        $videos   = db_connect()->select('id,title,niche,status,created_at')->from('videos')->where('user_id',$id)->orderBy('created_at','DESC')->limit(20)->get()->getResultArray();
        $logs     = $db->from('activity_logs')->where('user_id',$id)->orderBy('created_at','DESC')->limit(20)->get()->getResultArray();
